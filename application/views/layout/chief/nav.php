<nav class="navbar navbar-default navbar-fixed-top card-2">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand iransans" href="<?= base_url(); ?>chief">
                آشپز
            </a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="<?= base_url(); ?>chief">سفارشات</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-left">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?= $logger_info->firstname; ?> <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?= base_url(); ?>chief/profile">پروفایل</a></li>
                        <li><a href="<?= base_url(); ?>chief/change-username">تغییر نام کاربری</a></li>
                        <li><a href="<?= base_url(); ?>chief/change-password">تغییر کلمه عبور</a></li>
