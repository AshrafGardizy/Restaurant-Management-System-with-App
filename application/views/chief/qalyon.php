<div class="manage-section">
    ...
    <?php if ($qalyon_orders) : ?>
        <table class="table table-bordered table-striped">
            ...
            <?php $x = 1; foreach ($qalyon_orders as $item) : ?>
                <tr>
                    <!-- <td><?= $x; $x++; ?></td> -->
                    <td><?= $item->table_no; ?></td>
                    <td><?= $item->title; ?></td>
                    ...
                    <td><?= $item->price; ?></td>
                    <td>
                        <a onclick="return confirmation()" href="<?= base_url(); ?>qalyon/<?= $item->order_id; ?>/done" class="btn btn-info btn-sm">انجام شد</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
