<div class="manage-section">
    ...
    <?php if ($chief_orders) : ?>
        <table class="table table-bordered table-striped">
            ...
            <?php $x = 1; foreach ($chief_orders as $item) : ?>
                <tr>
                    <!-- <td><?= $x; $x++; ?></td> -->
                    <td><?= $item->table_no; ?></td>
                    <td><?= $item->title; ?></td>
                    ...
                    <td><?= $item->price; ?></td>
                    <td>
                        <a onclick="return confirmation()" href="<?= base_url(); ?>chief/<?= $item->order_id; ?>/done" class="btn btn-info btn-sm">انجام شد</a>
                    </td>
                    <td>
                        <a href="<?= base_url(); ?>chief/<?= $item->order_id; ?>/cancel" class="btn btn-danger btn-sm">لغو</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
